...
class GmallSearchApplicationTests {
    ...
    @Autowired
    private PmsGmallClient pmsClient;

    @Autowired
    private WmsGmallClient wmsClient;
    ...
    void contextLoads() {
        ...
        do {
            ...
            spuEntities.forEach(spuEntity -> {
                // 查询sku
                ResponseVo<List<SkuEntity>> skuResponseVo = this.pmsClient.getSkuBySpuId(spuEntity.getId());
                ...
                if (!CollectionUtils.isEmpty(skuEntities)){
                    List<Goods> goodsList = skuEntities.stream().map(skuEntity -> {
                        ...
                        ResponseVo<List<WareSkuEntity>> wareSkuResponseVo = this.wmsClient.getWareSkuBySkuId(skuEntity.getId());
                        ...
                        ResponseVo<List<SkuAttrValueEntity>> skuSearchAttrResponseVo = this.pmsClient.querySkuAttrValueBySkuId(skuEntity.getId());
                        ...
                        ResponseVo<List<SpuAttrValueEntity>> spuSearchAttrResponseVo = this.pmsClient.querySpuAttrValueBySpuId(spuEntity.getId());
